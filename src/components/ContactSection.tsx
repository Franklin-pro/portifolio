...
const ContactSection = () => {
  return (
    <section id="contact" className="py-20 relative overflow-hidden">
      ...
      <div className="absolute -left-32 -bottom-32 w-64 h-64 rounded-full bg-green-500/10 blur-3xl -z-10"></div>
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row md:justify-center gap-4 mb-6">
            <p className="text-md bg-green-500/25 p-2 rounded-sm  max-w-2xl text-start mx-auto pb-2">
          ...
          <p className="text-md  bg-green-500/25 p-2 rounded-sm text-start max-w-2xl mx-auto">
        ...
        <div className="grid md:grid-cols-1 gap-10 items-start">
            ...
            <div className="space-y-6">
              ...
              <div className="pt-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full bg-green-500 text-white px-6 py-3 rounded-sm font-semibold hover:bg-green-600 transition-colors inline-flex items-center justify-center gap-2"
                >
          ...
          {/* <div className="glass-card p-8 h-full">
            ...
            <form className="space-y-5">
              <div className="grid md:grid-cols-2 gap-5">
                <div>
                  ...
                  <input 
                    type="text" 
                    id="name" 
                    className="w-full px-4 py-3 bg-background/50 border border-foreground/10 rounded-sm focus:ring-2 focus:ring-primary/50 focus:border-transparent outline-none transition-all" 
              ...
              <button 
                type="submit" 
                className="w-full bg-gradient-to-r from-primary to-green-600 text-white py-3 px-6 rounded-sm font-semibold hover:opacity-90 transition-all flex items-center justify-center gap-2"
              >
                Send Message
            ...
            <div className="mt-6 pt-6 border-t border-foreground/10 text-center">
              ...
              <a 
                href="#" 
                className="inline-flex items-center gap-2 text-green-600 font-medium hover:opacity-80 transition-opacity"
              >
